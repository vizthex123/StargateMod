...
// Code definitely not stolen from Example Mod
namespace StargateMod.Tiles
{
	public class NaquadahOre : ModTile
	{
		public override void SetStaticDefaults() {
			...
			Main.tileOreFinderPriority[Type] = 450; // Renders over Meteorite in a Metal Detector
			Main.tileShine2[Type] = true; // Modifies the draw color slightly.
			Main.tileShine[Type] = 975; // How often tiny dust appear off this tile. Larger is less frequent.
			Main.tileMergeDirt[Type] = true;
			Main.tileSolid[Type] = true;
			Main.tileBlockLight[Type] = true;

			ModTranslation name = CreateMapEntryName();
			name.SetDefault("NaquadahOre");
			AddMapEntry(new Color(152, 171, 198), name);

			DustType = 84;
			ItemDrop = ModContent.ItemType<Items.Naquadah>();
